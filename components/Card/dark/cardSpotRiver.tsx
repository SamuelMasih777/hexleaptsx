...
export default function CardSpotRiver() {
    return (
      <div className="flex transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-105">
        <div className="max-w-64 bg-neutral-700">
          <div>
            <div className="border-b-2 border-dashed border-slate-500">
            <img
            ...
            <h1 className="flex px-4 mt-4 font-medium text-lg text-slate-50 justify-center item-center">Sacramento River Cats</h1>
            <div className="p-2 m-2 ">
             <div className="flex flex-row text-slate-300 justify-center item-center">
                <h1>OCT 15 | SUN | 4:30 PM</h1>
             </div>
             <div className="mt-2 flex flex-row text-slate-300 text-center justify-center item-center">
